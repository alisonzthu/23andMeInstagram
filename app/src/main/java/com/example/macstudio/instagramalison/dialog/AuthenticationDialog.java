...
public class AuthenticationDialog extends Dialog{
    ...
    private java.lang.String mUrl = "https://api.instagram.com/oauth/authorize/?client_id=" + ApplicationConsts.CLIENT_ID + "&redirect_uri=" + ApplicationConsts.REDIRECT_URI + "&response_type=code&display=touch&scope=public_content";
